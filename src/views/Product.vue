            ...
            <div class="row">
              <div class="col-lg-6">
                ...
                <div class="product-thumbs">
                  <carousel
                    ...
                    :nav="false"
                  >
                    <div class="pt " @click="changeImage(thumbs[0])" :class="thumbs[0] == image ? 'active' : ''">
                      <img src="img/mickey1.jpg" alt="" />
                    </div>

                    <div class="pt" @click="changeImage(thumbs[1])" :class="thumbs[1] == image ? 'active' : ''">
                      <img src="img/mickey2.jpg" alt="" />
                    </div>

                    <div class="pt" @click="changeImage(thumbs[2])" :class="thumbs[2] == image ? 'active' : ''">
                      <img src="img/mickey3.jpg" alt="" />
                    </div>

                    <div class="pt" @click="changeImage(thumbs[3])" :class="thumbs[3] == image ? 'active' : ''">
              ...
              <div class="col-lg-6">
                <div class="product-details text-left">
                  ...
                  <div class="quantity">
                    <router-link to="/ShoppingCart"><a href="#" class="primary-btn pd-cart"
                      >Add To Cart</a
                    ></router-link>
                  </div>
                </div>
